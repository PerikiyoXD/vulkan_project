...
void Vulkan::Instance::create()
{
    ...
    bool enableValidationLayers =
        true; // You can toggle this based on your build config
...
VkInstance Vulkan::Instance::getInstance() const { return instance; }

void Vulkan::Instance::cleanup() { vkDestroyInstance(instance, nullptr); }
