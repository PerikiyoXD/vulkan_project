...
void Vulkan::Pipeline::create(Device &device, SwapChain &swapChain,
...
VkPipeline Vulkan::Pipeline::getPipeline() const { return graphicsPipeline; }
...
VkShaderModule
Vulkan::Pipeline::createShaderModule(const std::vector<char> &code,
                                     Device &device)
{
