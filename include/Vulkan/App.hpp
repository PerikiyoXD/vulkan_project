...
class App
{
  ...
  protected:
    ...
    virtual void
    drawFrame(); // Method to render a frame, meant to be overridden
    virtual void
    initVertexData() = 0; // Pure virtual method for initializing vertex data
    virtual void cleanup();       // Cleanup Vulkan resources
